...
**⚡ 场景1：单日闪电暴跌 (-1.5% 到 -2%)**
- **逻辑**：散户恐慌，次日易爆炒出极端溢价。
- **参数参考**：【3个月持有】+【10%收益】+【回归1%溢价】
- **操作**：若场内实际溢价超越算出的临界值(如6%-8%)，**果断卖场内 ➡️ 大额买南向通**，瞬间无风险套利！顺手将021000的5K额度打满。

**⚠️ 场景2：正常回调区 (-5% 到 -10%)**
- **逻辑**：通常横盘震荡1-2个月，反弹空间不足以抵消南向通20%税率。
- **参数参考**：【3-6个月持有】+【10%-15%收益】+【回归1%溢价】
- **操作**：**021000的绝对主战场**！只要场内溢价未超越临界值，就每天无脑拉满5K额度，零溢价免税吸筹。

**🔥 场景3：修正大跌 (-10% 到 -20%)**
- **逻辑**：修复期0.5-1年，反弹空间极大，高收益足以覆盖南向通税费。
- **参数参考**：【6-12个月持有】+【20%收益】+【回归1%溢价】
- **操作**：021000继续每天5K。伴随极度恐慌的V型底部时，若场内溢价>3-4%，**掏出重金用南向通一把梭哈**。

**🩸 场景4：熊市大底 (< -20%)**
- **逻辑**：漫长熊市(1-3年)，南向通长期持有的复利摩擦和高额税费会吞噬大量本金。
- **参数参考**：【2-3年持有】+【40%-50%收益】+【回归0%溢价】 (临界溢价率将高达12%以上！)
- **操作**：不论当下溢价多高，**必须死磕买场内ETF**或雷打不动定投021000，在绝望岁月里收集长线免税筹码。
""")
