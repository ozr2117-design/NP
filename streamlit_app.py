...
with st.sidebar.expander("📖 科学参数设置实战指南"):
    st.markdown("""
**💡 场景1：单日暴跌 (赚取情绪溢价)**
- **逻辑**：纳指单日下跌 **1.5% - 2%** 以上时，散户次日易恐慌抢筹导致场内溢价瞬间飙升(如7%-8%)。
- **参数**：【3个月】+【10%收益】+【卖出时回归1%溢价】
- **实战**：临界值通常在3%-4%。若实际溢价达8%，**果断卖场内、买南向通**，白赚泡沫差价！

**⚠️ 场景2：回调区 (-5% 到 -10%)**
- **逻辑**：正常回调，反弹空间(约10%)不足以抵消南向通20%的利润税。
- **参数**：【3至6个月】+【10至15%收益】+【卖出时1%溢价】
- **实战**：只要场内溢价未超越临界值，**优先买场内ETF**，免税优势最大！

**🔥 场景3：修正大跌 (-10% 到 -20%)**
- **逻辑**：修复期长，反弹空间大，南向通的黄金击球区！
- **参数**：【半年-1年】+【20%反弹收益】+【卖出时1%溢价】
- **实战**：高绝对收益抵消了税费，完美规避场内“杀溢价”。若场内溢价>3%至4%，**果断买南向通**。

**🩸 场景4：熊市暴跌 (< -20%)**
- **逻辑**：长达2-3年的修复。若反弹50%，南向通20%的利得税将吞噬大量本金。
- **参数**：【2-3年】+【40%至50%收益】+【卖出时0%至1%溢价】
- **实战**：临界溢价率算出来会高达 **12% 以上**！这意味着抄底长期熊市大底时，无论当下溢价多高，**必须死磕买场内ETF**！
""")
